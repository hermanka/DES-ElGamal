...
const
  BitIP: array[0..63] of Byte =   // matriks IP
  ...
  BitCP: array[0..63] of Byte = // Matriks IP-1
  ...
  BitExp: array[0..47] of Integer = // Matriks Ekspansi E
    ( 31, 0, 1, 2, 3, 4, 3, 4, 5, 6, 7, 8, 7, 8, 9,10,
      11,12,11,12,13,14,15,16,15,16,17,18,19,20,19,20,
      21,22,23,24,23,24,25,26,27,28,27,28,29,30,31,0  );

  BitPM: array[0..31] of Byte =  // Matriks Permutasi
    ( 15, 6,19,20,28,11,27,16, 0,14,22,25, 4,17,30, 9,
       1, 7,23,13,31,26, 2, 8,18,12,29, 5,21,10, 3,24 );

  sBox: array[0..7] of array[0..63] of Byte =    // 8 Kotak S (S-Box)
  ...
  BitPMC1: array[0..55] of Byte = // Matriks PC-1
    ( 56, 48, 40, 32, 24, 16,  8,
       0, 57, 49, 41, 33, 25, 17,
       9,  1, 58, 50, 42, 34, 26,
      18, 10,  2, 59, 51, 43, 35,
  ...
  BitPMC2: array[0..47] of Byte =// Matriks PC-2
    ( 13, 16, 10, 23,  0,  4,
       2, 27, 14,  5, 20,  9,
      22, 18, 11,  3, 25,  7,
      15,  6, 26, 19, 12,  1,
...
begin
  if (Length(Str) > 0) and (Ord(Str[Length(Str)]) = 0) then
    raise Exception.Create('Error: Karakter terakhir null');
  ...
  begin
    ...
    begin
      ...
      if (ch >= '0') and (ch <= '9') then
        ...
        Res := Res * 16 + Ord(ch) - Ord('a') + 10
      else raise Exception.Create('Error: Chiperteks Bukan Heksadesimal!!');
    end;
    Result := Res;
  end;
